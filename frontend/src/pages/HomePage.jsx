...
import FriendCard, { getLanguageLogo } from "../components/FriendCard";
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="opacity-70">
                 Discover coding partners who complement your skillset and learning journey
                </p>
              </div>
            </div>
          </div>
                    ...
                    <div className="card-body p-5 space-y-4">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        <span className="badge badge-secondary">
                          {getLanguageLogo(user.nativeLanguage)}
                          Native: {capitialize(user.nativeLanguage)}
                        </span>
                        <span className="badge badge-outline">
                          {getLanguageLogo(user.learningLanguage)}
